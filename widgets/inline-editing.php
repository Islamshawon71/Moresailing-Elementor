...
class Inline_Editing extends Widget_Base
{
	...
	{
		return __('Inline Editing', 'elementor-moresailing');
	}
	...
	protected function _register_controls()
	{
		...
		$this->add_control(
			...
			[
				...
				'default' => __('Title', 'elementor-moresailing'),
			]
		);
		...
		$this->add_control(
			'description',
			[
				'label' => __('Description', 'elementor-moresailing'),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __('Description', 'elementor-moresailing'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __('Content', 'elementor-moresailing'),
			]
		);
